                    ...
                    <form ng-submit="ctrl.addGame()" name="gameForm" class="form-horizontal">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                ...
                                <button data-ng-if="ctrl.game" type="reset" class="btn btn-secondary btn-sm" onClick="window.location.reload();">Clear</button>
                            </div>
                            </div>
                        </div>
                    </form>
                    ...
                    <table class="table table-dark table-striped text-light">
                        ...
                        <tbody>
                            <tr ng-repeat="currentGame in ctrl.games">
                                ...
                                <td><span ng-bind="currentGame.reviews.length"></span></td>
                                <td></td>
